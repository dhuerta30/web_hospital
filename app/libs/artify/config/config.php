...
$config["function_filter_and_search"] = false;
...
//Upload folder URL
$config["uploadURL"] = $config["script_url"] . "artify/uploads/";
//download folder
$config["downloadFolder"] = ArtifyABSPATH . "downloads/";
//Download folder URL
$config["downloadURL"] = $_ENV["BASE_URL"] . "app/libs/" . $config["script_url"] . "artify/downloads/";
...
$config["showUploadedImage"] = false;
