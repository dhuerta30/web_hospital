...
class ArtifyView {
    ...
    public function renderArray($columns, $searchbox, $data, $objKey, $lang, $modal, $settings, $pagination, $perPageRecords, $btnActions, $extraData){
        ob_start();
        $template = strtolower($settings["template"]);
        require $this->template_path . "/$template/template-array.php";
        $output = ob_get_contents();
        ob_end_clean();
        return $output;
    }
