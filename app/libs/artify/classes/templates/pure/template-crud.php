        ...
        <div class="page-title clearfix panel-heading artify-table-heading">
            ...
            <?php if ($settings["addbtn"]) { ?>
                <div class="btn-group pull-right">
                    <a title="<?php echo $lang["add"]; ?>" class="artify-actions artify-button artify-button-add btn btn-success" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>">
            ...
            <?php if ($settings["savebtn"]) { ?>
                <div class="btn-group pull-right">
                    <a title="<?php echo $lang["save"]; ?>" class="artify-actions artify-button artify-button-save btn btn-success" href="javascript:;" data-action="save_crud_table_data" data-obj-key="<?php echo $objKey; ?>">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        <?php echo $lang["save"]; ?>
                    </a>                    
                </div>
                    ...
                    <div class="row artify-search">
                        ...
                        <?php if ($settings["deleteMultipleBtn"]) { ?>
                            <div class="col-md-1 col-sm-1 col-xs-1 no-padding">
                                <a title="<?php echo $lang["delete_selected"]; ?>" class="artify-actions artify-button artify-button-delete-all btn btn-danger" href="javascript:;" data-action="delete_selected" data-rendertype="CRUD" data-obj-key="<?php echo $objKey; ?>">
                    ...
                    <div class="col-sm-6">
                        <ul class="artify-export-options">
                            <?php if ($settings["printBtn"]) { ?>
                                <li><a title="<?php echo $lang["print"]; ?>" class="artify-actions artify-button artify-button-export" href="javascript:;" data-action="exporttable" data-export-type="print" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["csvBtn"]) {
                                ?> 
                                <li>
                                    <a title="<?php echo $lang["csv"]; ?>" class="artify-actions artify-button artify-button-export" href="javascript:;" data-action="exporttable" data-export-type="csv" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["pdfBtn"]) {
                                ?>
                                <li><a title="<?php echo $lang["pdf"]; ?>"class="artify-actions artify-button artify-button-export" href="javascript:;" data-action="exporttable" data-export-type="pdf" data-objkey="<?php echo $objKey; ?>">
                            ...
                            if ($settings["excelBtn"]) { ?>
                                <li><a title="<?php echo $lang["excel"]; ?>" class="artify-actions artify-button artify-button-export" href="javascript:;" data-action="exporttable" data-export-type="excel" data-objkey="<?php echo $objKey; ?>">
                                        <i class="fa fa-file" aria-hidden="true"></i>
                                            <?php echo $lang["excel"]; ?>
                                    </a>
                                </li>
