    ...
    <div class="card">
        ...
        <div class="page-title clearfix card-header artify-table-heading">
            ...
            <?php if ($settings["savebtn"]) { ?>
                <div class="btn-group float-right">
                    <a title="<?php echo $lang["save"]; ?>" class="artify-actions artify-button artify-button-save green guardar_datos btn btn-primary text-white" href="javascript:;" data-action="save_crud_table_data" data-obj-key="<?php echo $objKey; ?>">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i>
                        <?php echo $lang["save"]; ?>
                    </a>
                </div>
            ...
            if (isset($extraData["btnTopAction"]) && is_array($extraData["btnTopAction"]) && count($extraData["btnTopAction"])) {
                ...
                ?>
                    <div class="btn-group float-right">
                        <a title="<?php echo $text; ?>" class="artify-top-actions artify-button <?php echo $cssClass; ?> artify-button-<?php echo $action_name; ?>" href="<?php echo $url; ?>" data-action="<?php echo $action_name; ?>" data-obj-key="<?php echo $objKey; ?>">
                            <i class="fa fa-plus-circle"></i> <?php echo $text; ?>
                        </a>
                    </div>
            <?php }
            }
            ...
            <div class="row artify-options-files">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <ul class="artify-export-options">
                        ...
                        if ($settings["csvBtn"]) {
                        ?>
                            <li><a title="<?php echo $lang["csv"]; ?>" class="artify-actions artify-button artify-button-export" href="javascript:;" data-action="exporttable" data-export-type="csv" data-objkey="<?php echo $objKey; ?>"><i class="fa fa-file-o"></i> <?php echo $lang["csv"]; ?></a></li>
                        <?php
                        }
                        if ($settings["pdfBtn"]) {
                        ?>
                        ...
                        if ($settings["excelBtn"]) { ?>
                            <li><a title="<?php echo $lang["excel"]; ?>" class="artify-actions artify-button artify-button-export" href="javascript:;" data-action="exporttable" data-export-type="excel" data-objkey="<?php echo $objKey; ?>"><i class="fa fa-file-excel"></i> <?php echo $lang["excel"]; ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
