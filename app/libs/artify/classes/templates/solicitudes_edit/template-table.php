                ...
                <tr data-id="<?php if (isset($rows[$pk])) echo $rows[$pk]; ?>" id="artify-row-<?php echo $rowcount; ?>" class="artify-data-row <?php if (isset($rows[0]["class"])) echo $rows[0]["class"]; ?>" <?php if (isset($rows[0]["style"])) echo $rows[0]["style"]; ?>>
                    ...
                    ?>
                        <td class="artify-row-actions">
                            <a class="btn btn-default btn-sm ver_solicitudes" href="javascript:;" title="Imprimir" data-id="<?=$rows[$pk]?>">
                                <i class="fa fa-print"></i>
                            </a> 
                            <a class="btn btn-default btn-sm ver_etiquetas" href="javascript:;" title="Etiqueta" data-id="<?=$rows[$pk]?>">
                                <i class="fa fa-barcode"></i>
                            </a> 
                            <a class="btn btn-default btn-sm ver_resultado" href="javascript:;" title="Resultado" data-id="<?=$rows[$pk]?>">
                                <i class="fa fa-upload"></i>
                            </a> 
                            <a class="btn btn-default btn-sm ver_pdf" href="javascript:;" title="PDF" data-id="<?=$rows[$pk]?>">
