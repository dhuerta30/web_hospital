        ...
        <div class="page-title clearfix card-header artify-table-heading">
            ...
            <?php if ($settings["addbtn"]) { ?>
                <div class="btn-group float-right">
                    <a title="<?php echo $lang["add"]; ?>" class="artify-actions artify-button artify-button-add green btn btn-success" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>">
