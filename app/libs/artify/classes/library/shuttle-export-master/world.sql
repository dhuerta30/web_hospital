-- Generation time: Sun, 09 Sep 2018 21:59:25 +0200
-- Host: localhost
-- DB name: artify
...
('95','Teegan','Jimenez','5503 Odio, Rd.','Guánica','SC','12336'),
...
INSERT INTO `jm_users` VALUES ('1','','fucking girlfriend','','','0','0','0000-00-00 00:00:00','0000-00-00 00:00:00','','','0000-00-00 00:00:00','0','','','0','http://artify.com/script/uploads/1481931260_parte1.jpg'),
...
('10','','asdasdas','','','0','0','0000-00-00 00:00:00','0000-00-00 00:00:00','','','0000-00-00 00:00:00','0','','','0','http://artify.com/script/uploads/1481696679_50ib.png'),
...
INSERT INTO `language` VALUES ('1','login','login','????','login','????','login','?????','??','giri?','login','bejelentkez�s','Connexion','???????','Login','login','???????????','??? ??','?????','login','login','????','???'),
('2','account_type','account type','?????????? ????','tipo de cuenta','??? ??????','type account','??? ?????','????','hesap t�r�','tipo de conta','fi�k t�pus�t','Type de compte','??? ???? ??? ???????????','Kontotyp','tipo di account','???????????','?????? ?? ???','???? ??????','propter speciem','Jenis akun','?????','?? ??'),
('3','admin','admin','????????','administraci�n','????','admin','?????','??','y�netim','administrador','admin','administrateur','?? admin','Admin','Admin','???????????','?????','???????','Lorem ipsum dolor sit','admin','???','???'),
('4','teacher','teacher','??????','profesor','????','leraar','???????','??','�?retmen','professor','tan�r','professeur','????????','Lehrer','insegnante','???','?????','??????','Magister','guru','??','??'),
('5','student','student','?????','estudiante','????','student','???????','??','�?renci','estudante','di�k','�tudiant','????????','Sch�ler','studente','????????','???? ???','?????','discipulo','mahasiswa','??','??'),
('6','parent','parent','???? ?? ????','padre','???','ouder','????????','?','ebeveyn','parente','sz�l?','m�re','??????? ????????','Elternteil','genitore','?????????','??????','???? - ????','parente','induk','?','???'),
('7','email','email','?????','email','?????? ??????????','e-mail','?? ??????????? ?????','????','E-posta','e-mail','E-mail','email','e-mail','E-Mail-','e-mail','??????','?? ???','????','email','email','???','???'),
('8','password','password','??????????','contrase�a','???? ????','wachtwoord','??????','??','?ifre','senha','jelsz�','mot de passe','??? ??????','Passwort','password','????????','???','???????','Signum','kata sandi','?????','??'),
('9','forgot_password ?','forgot password ?','?????????? ???? ??????','�Olvid� su contrase�a?','???? ???? ???????','wachtwoord vergeten?','?????? ???????','?????','?ifremi unuttum?','Esqueceu a senha?','Elfelejtett jelsz�?','Mot de passe oubli�?','???????? ??? ??????;','Passwort vergessen?','dimenticato la password?','???????????','??? ??? ???? ????','???? ????????? ????','oblitus esne verbi?','lupa password?','??????????','????? ?? ????'),
('10','reset_password','reset password','?????????? ?????','restablecer la contrase�a','????? ????? ???? ??????','reset wachtwoord','???????? ??????','????','?ifrenizi s?f?rlamak','redefinir a senha','Jelsz� vissza�ll�t�sa','r�initialiser le mot de passe','??????????? ??? ?????? ?????????','Kennwort zur�cksetzen','reimpostare la password','???????????????','??? ??? ?? ???','??????? ?????','Duis adipiscing','reset password','???????????','??? ???'),
('11','reset','reset','????? ????','reajustar','????? ?????','reset','?????','??','ayarlamak','restabelecer','vissza','remettre','?????????','r�cksetzen','reset','????????','?? ???','????? ????','Duis','ulang','????','???'),
...
('13','account','account','?????','cuenta','????','rekening','????','??','hesap','conta','sz�mla','compte','???????????','Konto','conto','?????','??????','????','propter','rekening','?????','??'),
('14','profile','profile','??????','perfil','???','profiel','???????','??','profil','perfil','profil','profil','??????','Profil','profilo','???????','???????','???????','profile','profil','??????','???'),
('15','change_password','change password','?????????? ????????','cambiar la contrase�a','????? ???? ??????','wachtwoord wijzigen','???????? ??????','????','?ifresini de?i?tirmek','alterar a senha','jelsz� megv�ltoztat�sa','changer le mot de passe','???????? ??? ?????? ?????????','Kennwort �ndern','cambiare la password','???????????????','??? ??? ?????','??????? ?????????','mutare password','mengubah password','??????????','??? ??'),
('16','logout','logout','?? ???','logout','????? ??????','logout','?????','??','logout','Sair','logout','D�connexion','??????????','logout','Esci','??????????','??? ??? ????','??????','logout','logout','?????','?? ??'),
('17','panel','panel','???????','panel','????','paneel','??????','??','panel','painel','bizotts�g','panneau','???????','Platte','pannello','??????????','????','????','panel','panel','???','??'),
...
('19','dashboard','dashboard','??????????','salpicadero','???? ???????','dashboard','????????? ??????','???','g�sterge paneli','painel de instrumentos','m?szerfal','tableau de bord','??????','Armaturenbrett','cruscotto','???????','??? ????','????????','Dashboard','dasbor','???????','???'),
('20','student_help','student help','??????????? ???????','ayuda estudiantil','?????? ??????','student hulp','??????? ??????','?????','�?renci yard?m','ajuda estudante','di�k seg�ts�g�vel','aide aux �tudiants','???????? ???????','Sch�ler-Hilfe','help studente','?????????????????','???? ??? ?? ???','????? ???','Discipulus auxilium','membantu siswa','??????','?? ???'),
('21','teacher_help','teacher help','?????? ???????','ayuda del maestro','?????? ??????','leraar hulp','??????? ??????','?????','�?retmen yard?m','ajuda de professores','tan�r seg�ts�g�vel','aide de l\'enseignant','??????? ??? ?????????????','Lehrer-Hilfe','aiuto dell\'insegnante','????????????','????? ?? ???','?????? ???','doctor auxilium','bantuan guru','??????','??? ??'),
('22','subject_help','subject help','????? ???????','ayuda sujeto','?????? ???????','Onderwerp hulp','????????? ??????','????','konusu yard?m','ajuda assunto','t�rgy seg�ts�g�vel','l\'objet de l\'aide','?????????? ???????','Thema Hilfe','Aiuto Subject','???????????????????','????? ???','???? ???','agitur salus','bantuan subjek','?????','?? ??'),
('23','subject','subject','?????','sujeto','?????','onderwerp','????','??','konu','assunto','t�rgy','sujet','????','Thema','soggetto','??????','?????','????','agitur','subyek','???','??'),
('24','class_help','class help','???? ???????','clase de ayuda','?????? ??????','klasse hulp','????? ??????','????','s?n?f yard?m','classe ajuda','oszt�ly seg�ts�g�vel','aide de la classe','????????? ???????','Klasse Hilfe','help classe','????????????????????????','???? ???','????? ???','genus auxilii','kelas bantuan','???????','??? ??'),
('25','class','class','????','clase','???','klasse','?????','?','s?n?f','classe','oszt�ly','classe','?????????','Klasse','classe','????','????','????','class','kelas','???','???'),
('26','exam_help','exam help','????????? ???????','ayuda examen','?????? ??????','examen hulp','??????? ??????','????','s?nav yard?m','exame ajuda','vizsga help','aide � l\'examen','????????? ???????','Pr�fung Hilfe','esame di guida','???????????????????','?????? ???','??????? ???','ipsum Auxilium','ujian bantuan','?????','??? ??'),
('27','exam','exam','???????','examen','??????','tentamen','???????','??','s?nav','exame','vizsg�lat','exam','???????','Pr�fung','esame','??????','??????','???????','Lorem ipsum','ujian','??','??'),
('28','marks_help','marks help','????? ???????','marcas ayudan','?????? ??????','markeringen helpen','????? ????????','????','i?aretleri yard?m','marcas ajudar','jelek seg�tenek','marques aident','?????? ????????','Markierungen helfen','segni aiutano','???????????????','???? ???','????? ???','notas auxilio','tanda membantu','???????','??? ? ???'),
('29','marks-attendance','marks-attendance','?????-?????????','marcas-asistencia','??????-??????','merken-deelname','?????-????????????','????','i?aretleri-kat?l?m','marcas de comparecimento','jelek-ell�t�s','marques-participation','?????? ??????????','Marken-Teilnahme','marchi-presenze','??????????????????????','???? ?????','????? ????????','signa eius ministrabant,','tanda-pertemuan','???�??','?? ??'),
('30','grade_help','grade help','????? ???????','ayuda de grado','?????? ????','leerjaar hulp','?????? ??????','???','s?n?f yard?m','ajuda grau','fokozat help','aide de qualit�','?????? ???????','Grade-Hilfe','aiuto grade','?????????????','???? ???','????? ???','gradus ope','kelas bantuan','????????','? ??'),
('31','exam-grade','exam-grade','???????? ??????','examen de grado','?????? ????','examen-grade','??????? ??????','????','s?nav notu','exame de grau','vizsga-grade','examen de qualit�','????????? ?????????','Pr�fung-Grade','esami-grade','???????','?????? ????','??????? ?????','ipsum turpis,','ujian-grade','??????','?? ??'),
('32','class_routine_help','class routine help','??????? ????? ???????','clase ayuda rutina','?????? ?????? ???????','klasroutine hulp','????? ?????? ??????','?????','s?n?f rutin yard?m','classe ajuda rotina','oszt�ly rutin seg�t','classe aide routine','????????? ???????? ???????','Klasse Routine Hilfe','Classe aiuto di routine','?????????????????????????','???? ????? ???','???? ???????? ???','uno genere auxilium','kelas bantuan rutin','???????????','??? ?? ??'),
('33','class_routine','class routine','??????? ?????','rutina de la clase','??? ?????????','klasroutine','????? ???????????','???','s?n?f rutin','rotina classe','oszt�ly rutin','routine de classe','????????? ???????','Klasse Routine','classe di routine','?????????','???? ?????','???? ????????','in genere uno,','rutin kelas','???�????','??? ??'),
('34','invoice_help','invoice help','????? ???????','ayuda factura','?????? ????????','factuur hulp','????-??????? ??????','????','fatura yard?m','ajuda factura','sz�mla seg�ts�g�vel','aide facture','????????? ???????','Rechnungs Hilfe','help fattura','???????????????????','?????? ???','????? ??????','auxilium cautionem','bantuan faktur','??????','?? ??'),
('35','payment','payment','??????','pago','???','betaling','??????','??','�deme','pagamento','fizet�s','paiement','???????','Zahlung','pagamento','???????????','???????','??????','pecunia','pembayaran','???','??'),
('36','book_help','book help','?????? ???????','libro de ayuda','???? ????????','boek hulp','????? ??????','????','kitap yard?m?','livro ajuda','k�nyv seg�t','livre aide','??????? ??? ???????','Buch-Hilfe','della guida','????????????????','???? ???','?????? ???','auxilium libro,','Buku bantuan','???????','? ???'),
('37','library','library','?????????','biblioteca','?????','bibliotheek','??????????','??','k�t�phane','biblioteca','k�nyvt�r','biblioth�que','??????????','Bibliothek','biblioteca','????????','????????','?????????','library','perpustakaan','???','???'),
('38','transport_help','transport help','????????? ???????','ayuda de transporte','?????? ?????','vervoer help','????????? ??????','????','ula??m yard?m','ajuda de transporte','sz�ll�t�s S�g�','le transport de l\'aide','??????? ?? ????????','Transport Hilfe','help trasporti','?????????????????','??? ? ??? ???','?????? ???','auxilium onerariis','transportasi bantuan','??????','?? ??'),
('39','transport','transport','??????','transporte','???','vervoer','?????????','??','ta??ma','transporte','sz�ll�t�s','transport','????????','Transport','trasporto','????????','??? ? ???','??????','onerariis','angkutan','??','??'),
('40','dormitory_help','dormitory help','??????? ???????','dormitorio de ayuda','???? ????????','slaapzaal hulp','????????? ??????','????','yatakhane yard?m','dormit�rio ajuda','koll�giumi help','dortoir aide','??????? ???????','Wohnheim Hilfe','dormitorio aiuto','??????????????','??????? ???','????????? ???','dormitorium auxilium','asrama bantuan','?????','??? ???'),
('41','dormitory','dormitory','?????? - ???????','dormitorio','??????','slaapzaal','???????','??','yatakhane','dormit�rio','h�l�terem','dortoir','???????','Wohnheim','dormitorio','?????','???????','?????????','dormitorium','asrama mahasiswa','?','???'),
('42','noticeboard_help','noticeboard help','?????????? ???????','tabl�n de anuncios de la ayuda','??????? ??????','prikbord hulp','????? ??? ?????????? ??????','????','noticeboard yard?m','avisos ajuda','�zen?fal�n help','panneau d\'aide','???????????? ???????','Brett-Hilfe','bacheca aiuto','???????????????????????','noticeboard ???','Noticeboard ???','auxilium noticeboard','pengumuman bantuan','???????','? noticeboard ???'),
('43','noticeboard-event','noticeboard-event','??????????-??????','tabl�n de anuncios de eventos','??????? ?????','prikbord-event','????? ??? ??????????-???????','?????','noticeboard olay','avisos de eventos','�zen?fal�n esem�ny','panneau d\'�v�nement','???????????? ????????','Brett-Ereignis','bacheca-evento','??????????????????????','noticeboard ?????','Noticeboard ????','noticeboard eventus,','pengumuman-acara','???????','? noticeboard ???'),
('44','bed_ward_help','bed ward help','?????? ??????? ???????','cama ward ayuda','???? ???? ????????','bed ward hulp','??????? ?????????? ??????','??????','yatak ko?u? yard?m','ajuda cama enfermaria','�gy Ward help','lit salle de l\'aide','??????? ??????? ???????','Betten-Station Hilfe','Letto reparto aiuto','???????????????????','???? ???? ???','?????? ????? ???','lectum stans auxilium','tidur bangsal bantuan','?????????','?? ?? ??'),
('45','settings','settings','??????','configuraci�n','???????','instellingen','?????????','??','ayarlar?','defini��es','be�ll�t�sok','param�tres','?????????','Einstellungen','Impostazioni','??????????','???????','????????','occasus','Pengaturan','??','??'),
('46','system_settings','system settings','??????? ??????','configuraci�n del sistema','??????? ??????','systeeminstellingen','????????? ???????','????','sistem ayarlar?','configura��es do sistema','rendszerbe�ll�t�sokat','les param�tres du syst�me','????????? ??? ??????????','Systemeinstellungen','impostazioni di sistema','??????????????','???? ?? ???????','??????? ????????','ratio occasus','pengaturan sistem','??????','??? ??'),
('47','manage_language','manage language','???? ? ????????','gestionar idioma','????? ?????','beheren taal','????????? ????','????','dil y�netmek','gerenciar l�ngua','kezelni nyelv','g�rer langue','?????????? ??????','verwalten Sprache','gestire lingua','??????????','???? ?? ??????','???? ?? ???????','moderari linguam,','mengelola bahasa','?????','??? ??'),
...
('50','manage_student','manage student','?????????? ? ????????','gestionar estudiante','????? ??????','beheren student','????????? ????????','????','�?renci y�netmek','gerenciar estudante','kezelni di�k','g�rer �tudiant','?????????? ??? ????????','Sch�ler verwalten','gestire studente','??????????????','???? ??? ?? ??????','????? ?? ???????','curo alumnorum','mengelola siswa','?????','?? ??'),
('51','manage_teacher','manage teacher','?????? ? ????????','gestionar maestro','????? ??????','beheren leraar','????????? ???????','????','�?retmen y�netmek','gerenciar professor','kezelni tan�r','g�rer enseignant','?????????? ??? ?????????????','Lehrer verwalten','gestire insegnante','?????????','???? ?? ??????','?????? ?? ???????','magister curo','mengelola guru','?????','?? ??'),
('52','noticeboard','noticeboard','??????????','tabl�n de anuncios','???????','prikbord','????? ??? ??????????','??','noticeboard','quadro de avisos','�zen?fal�n','panneau d\'affichage','????????????','Brett','bacheca','??????????','noticeboard','Noticeboard','noticeboard','pengumuman','???','? noticeboard'),
('53','language','language','????','idioma','???','taal','????','?','dil','l�ngua','nyelv','langue','??????','Sprache','lingua','????','????','????','Lingua','bahasa','??','??'),
('54','backup','backup','???????','reserva','???','reservekopie','?????????','??','yedek','backup','ment�s','sauvegarde','?????????','Sicherungskopie','di riserva','??????????????','??? ??','?????','tergum','backup','??????','??'),
('55','calendar_schedule','calendar schedule','??????????? ????????','horario de calendario','?????? ??????','kalender schema','????????? ??????????','????','takvim program?','agenda calend�rio','napt�ri �temez�s','calendrier calendrier','????????????????? ??? ???????????','Kalender Zeitplan','programma di calendario','??????????????????','?????? ?????','??????? ???????','kalendarium ipsum','jadwal kalender','????????????','??? ??'),
('56','select_a_class','select a class','???? ?????? ????????','seleccionar una clase','??? ???','selecteer een class','???????? ?????','?????','bir s?n?f se�in','selecionar uma classe','v�lasszon ki egy oszt�lyt','s�lectionner une classe','???????? ??? ?????????','W�hlen Sie eine Klasse','selezionare una classe','?????????','??? ???? ????? ????','?? ???? ?? ??? ????','eligere genus','pilih kelas','??????','???? ??'),
('57','student_list','student list','??????????? ??????','lista de alumnos','????? ??????','student lijst','?????? ???????','????','�?renci listesi','lista de alunos','di�k lista','liste des �tudiants','???????? ??? ????????','Sch�lerliste','elenco degli studenti','???????????????','???? ??? ?? ?????','????? ????','Discipulus album','daftar mahasiswa','??????','?? ??'),
('58','add_student','add student','????? ???','a�adir estudiante','????? ????','voeg student','???????? ????????','????','�?renci eklemek','adicionar estudante','hozz� hallgat�','ajouter �tudiant','????????? ????????','Student hinzuf�gen','aggiungere studente','?????????????','???? ??? ????','????? ????','adde elit','menambahkan mahasiswa','?????','??? ??'),
('59','roll','roll','???','rollo','???','broodje','?????','?','rulo','rolo','tekercs','rouleau','????','Rolle','rotolo','????','???','???','volumen','gulungan','???','?'),
('60','photo','photo','???','foto','???','foto','????','??','foto?raf','foto','f�nyk�p','photo','??????????','Foto','foto','???????','?????','?????','Lorem ipsum','foto','??','??'),
('61','student_name','student name','??????????? ???','Nombre del estudiante','??? ??????','naam van de leerling','??? ????????','????','�?renci ad?','nome do aluno','tanul� nev�t','nom de l\'�tudiant','?? ????? ??? ??????','Studentennamen','nome dello studente','????????????','???? ??? ?? ???','????? ?? ???','ipsum est nomen','nama siswa','?????','??? ??'),
('62','address','address','??????','direcci�n','?????','adres','?????','??','adres','endere�o','c�m','adresse','?????????','Adresse','indirizzo','???????','??????','???','Oratio','alamat','????','??'),
('63','options','options','????','Opciones','??????','opties','?????','??','se�enekleri','op��es','lehet?s�gek','les options','????????','Optionen','Opzioni','????????','????????','??????','options','Pilihan','?????','??'),
...
('65','id_card','id card','???? ?????','carnet de identidad','????? ??????','id-kaart','????????????? ????????','???','kimlik kart?','carteira de identidade','szem�lyi igazolv�ny','carte d\'identit�','id ?????','Ausweis','carta d\'identit�','???????????','?????? ????','? ?? ?????','id ipsum','id card','ID???','???'),
('66','edit','edit','??????? ???','editar','?????','uitgeven','?????????????','??','d�zenleme','editar','szerkeszt','modifier','edit','bearbeiten','modifica','?????','??? ????? ????','??????? ????','edit','mengedit','??','??'),
('67','delete','delete','???? ????','borrar','???','verwijderen','???????','??','silmek','excluir','t�r�l','effacer','????????','l�schen','cancellare','??','????','?????','vel deleri,','menghapus','????','??'),
('68','personal_profile','personal profile','????????? ????????','perfil personal','??? ????','persoonlijk profiel','?????? ???????','????','ki?isel profil','perfil pessoal','szem�lyes profil','profil personnel','????????? ??????','pers�nliches Profil','profilo personale','???????????????????????','???? ???????','????????? ????????','personal profile','profil pribadi','????','?? ???'),
('69','academic_result','academic result','???????? ?????','resultado acad�mico','????? ??????????','academische resultaat','????????????? ?????????','????','akademik sonu�','resultado acad�mico','tudom�nyos eredm�ny','r�sultat acad�mique','?????????? ??????????','Studienergebnis','risultato accademico','??????????','?????? ?????','??????? ??????','Ex academicis','Hasil akademik','????','?? ????'),
('70','name','name','???','nombre','???','naam','????????','??','isim','nome','n�v','nom','?????','Name','nome','????','???','???','nomen,','nama','??','??'),
('71','birthday','birthday','???????','cumplea�os','??? ?????','verjaardag','???? ????????','??','do?um g�n�','anivers�rio','sz�let�snap','anniversaire','????????','Geburtstag','compleanno','???????','??????','???????','natalis','ulang tahun','???','??'),
('72','sex','sex','?????','sexo','???','seks','????','??','seks','sexo','szex','sexe','????','Sex','sesso','???','????','????','sex','seks','????','??'),
('73','male','male','?????','masculino','???','mannelijk','???????','??','erkek','masculino','f�rfi','m�le','?????????','m�nnlich','maschio','??????','???????','??','masculus','laki-laki','??','??'),
('74','female','female','?????','femenino','????','vrouw','???????','?','kad?n','feminino','n?i','femelle','???????','weiblich','femminile','???????','??????','?????','femina,','perempuan','??','??'),
('75','religion','religion','????','religi�n','???','religie','???????','??','din','religi�o','vall�s','religion','????????','Religion','religione','?????','????','????','religionis,','agama','??','??'),
('76','blood_group','blood group','?????? ?????','grupo sangu�neo','????? ????','bloedgroep','?????? ?????','??','kan grubu','grupo sangu�neo','v�rcsoport','groupe sanguin','????? ???????','Blutgruppe','gruppo sanguigno','??????????','??? ?? ????','???? ????','sanguine coetus','golongan darah','???','???'),
('77','phone','phone','???','tel�fono','????','telefoon','???????','??','telefon','telefone','telefon','t�l�phone','????????','Telefon','telefono','????????','???','????','Praesent','telepon','??','??'),
('78','father_name','father name','????? ???','Nombre del padre','??? ????','naam van de vader','????????','????','baba ad?','nome pai','apa n�v','nom de p�re','?? ????? ??? ??????','Der Name des Vaters','nome del padre','???????','???? ?? ???','???? ?? ???','nomine Patris,','Nama ayah','?????','???? ??'),
('79','mother_name','mother name','?????? ???','Nombre de la madre','??? ????','moeder naam','??? ??????','?????','anne ad?','Nome m�e','anyja n�v','nom de la m�re','?? ????? ??? ???????','Name der Mutter','Nome madre','???????','??? ?? ???','???? ?? ???','matris nomen,','Nama ibu','????','??? ??'),
('80','edit_student','edit student','???????? ?????','edit estudiante','????? ??????','bewerk student','?????????????? ???????','????','edit �?renci','edi��o aluno','szerkeszt�s di�k','modifier �tudiant','??????????? ??? ????????','Sch�ler bearbeiten','modifica dello studente','?????????????','????? ?? ???? ???','??????? ?????','edit studiosum','mengedit siswa','????','?? ??'),
('81','teacher_list','teacher list','?????? ??????','lista maestra','????? ??????','leraar lijst','?????? ????????','????','�?retmen listesi','lista de professores','tan�r lista','Liste des enseignants','????? ??? ?????????????','Lehrer-Liste','elenco degli insegnanti','??????????','????? ?????','?????? ????','magister album','daftar guru','?????','??? ??'),
('82','add_teacher','add teacher','?????? ???','a�adir profesor','????? ??????','voeg leraar','???????? ???????','????','�?retmen ekle','adicionar professor','hozz� tan�r','ajouter enseignant','????????? ????????','Lehrer hinzuf�gen','aggiungere insegnante','????????','????? ????','?????? ????','Magister addit','menambah guru','?????','??? ??'),
('83','teacher_name','teacher name','?????? ???','Nombre del profesor','??? ??????','leraarsnaam','??? ???????','????','�?retmen ad?','nome professor','tan�r n�v','nom des enseignants','????? ??? ?????????????','Lehrer Name','Nome del docente','???????','????? ?? ???','?????? ?? ???','magister nomine','nama guru','???','?? ??'),
('84','edit_teacher','edit teacher','???????? ??????','edit maestro','????? ??????','leraar bewerken','??????? ???????','????','edit �?retmen','editar professor','szerkeszt�s tan�r','modifier enseignant','edit ?????????????','edit Lehrer','modifica insegnante','????????','????? ?????','??????? ???? ??????','edit magister','mengedit guru','?????','?? ??'),
('85','manage_parent','manage parent','??????? ? ????????','gestionar los padres','????? ????','beheren ouder','????????? ?????????','?????','ebeveyn y�netmek','gerenciar pai','kezelni sz�l?','g�rer parent','?????????? ???????','verwalten Mutter','gestione genitore','????????????','?????? ?? ??????','???? - ???? ?? ???????','curo parent','mengelola orang tua','????','?? ??'),
('86','parent_list','parent list','??? ??????','lista primaria','????? ??????','ouder lijst','????????????? ??????','???','ebeveyn listesi','lista pai','sz�l? lista','liste parent','??????? ?????','geordneten Liste','elenco padre','????????????????','?????? ?? ?????','???? - ???? ????','parente album','daftar induk','????','?? ??'),
('87','parent_name','parent name','??? ???','Nombre del padre','??? ??????','oudernaam','???????? ????????','??','ebeveyn isim','nome do pai','sz�l? n�v','nom du parent','??????? ?????','Mutternamen','nome del padre','?????????????','?????? ?? ???','???? - ???? ?? ???','Nomen parentis,','nama orang tua','????','?? ??'),
('88','relation_with_student','relation with student','???????? ????? ???????','relaci�n con el estudiante','??????? ?? ??????','relatie met student','????????? ? ????????','?????','�?renci ile ili?kisi','rela��o com o aluno','kapcsolatban di�k','relation avec l\'�l�ve','????? ?? ??? ??????','Zusammenhang mit Studenten','rapporto con lo studente','???????????????????????','???? ??? ?? ???? ????','?????? ?? ??? ?????','cum inter ipsum','hubungan dengan siswa','??????','???? ??'),
('89','parent_email','parent email','??? ?????','correo electr�nico de los padres','?????? ?????????? ????','ouder email','???????? ??????','???????','ebeveyn email','e-mail dos pais','sz�l? e-mail','parent email','email ??? ?????','Eltern per E-Mail','email genitore','???????????????','?????? ?? ?? ???','???? - ???? ????','parente email','email induk','??????','??? ???'),
('90','parent_phone','parent phone','???????? ???','tel�fono de los padres','?????? ????????','ouder telefoon','???????? ???????','????','ebeveyn telefon','telefone dos pais','sz�l? telefon','m�re de t�l�phone','??????? ????????','Elterntelefon','telefono genitore','????????????????????','?????? ???','???? - ???? ?? ???','parentis phone','telepon orang tua','??????','?? ??'),
('91','parrent_address','parrent address','parrent ??????','Direcci�n Parrent','????? parrent','parrent adres','Parrent ?????','parrent??','parrent adresi','endere�o Parrent','parrent c�m','adresse Parrent','parrent ?????????','parrent Adresse','Indirizzo parrent','??????? parrent','parrent ??????','parrent ???','oratio parrent','alamat parrent','parrent????','parrent ??'),
('92','parrent_occupation','parrent occupation','parrent ??????','ocupaci�n Parrent','???????? parrent','parrent bezetting','Parrent ?????????','parrent??','parrent i?gal','ocupa��o Parrent','parrent Foglalkoz�s','occupation Parrent','parrent ?????????','parrent Beruf','occupazione parrent','????? parrent','parrent ????','parrent ?????','opus parrent','pendudukan parrent','parrent??','parrent ??'),
('93','add','add','??? ???','a�adir','?????','toevoegen','?????????','?','eklemek','adicionar','hozz�ad','ajouter','????????','hinzuf�gen','aggiungere','?????','????','??????','Adde','menambahkan','???','??'),
('94','parent_of','parent of','???????','matriz de','???? ?','ouder van','????????','?','ebeveyn','pai','sz�l?','parent d\'','??????','Muttergesellschaft der','madre di','????????????','??????','?? ???? - ????','parentem,','induk dari','??','? ??'),
('95','profession','profession','????','profesi�n','????','beroep','?????????','??','meslek','profiss�o','szakma','profession','?????????','Beruf','professione','?????','????','???????','professio','profesi','??','??'),
('96','edit_parent','edit parent','???????? ????????','edit padres','????? ????????','bewerk ouder','??????? ????????','???','edit ebeveyn','edi��o pai','szerkeszt�s sz�l?','modifier parent','edit ?????','edit Mutter','modifica genitore','??????????????','??? ????? ???? ??????','??????? ???','edit parent','mengedit induk','???','?? ??'),
('97','add_parent','add parent','???????? ???','a�adir los padres','????? ??????','Voeg een ouder','???????? ????????','???','ebeveyn ekle','adicionar pai','hozz� sz�l?','ajouter parent','????????? ???????','Mutter hinzuf�gen','aggiungere genitore','??????????????','?????? ????','???? - ???? ????','adde parent','menambahkan orang tua','????','??? ??'),
('98','manage_subject','manage subject','????? ? ????????','gestionar sujeto','????? ???????','beheren onderwerp','????????? ????','????','konuyu y�netmek','gerenciar assunto','kezelni t�rgy','g�rer sujet','?????????? ?????????','Thema verwalten','gestire i soggetti','???????????????','????? ?? ??????','???? ?? ???????','subiectum disponat','mengelola subjek','?????','?? ??'),
('99','subject_list','subject list','????? ??????','lista por materia','????? ???????','Onderwerp lijst','?????? ????????','????','konu listesi','lista por assunto','t�ma lista','liste de sujets','?????????? ?????','Themenliste','lista soggetto','????????????','????? ?? ?????','???? ????','subiectum album','daftar subjek','?????????','?? ??'),
('100','add_subject','add subject','????? ???','A�adir asunto','????? ???????','Onderwerp toevoegen','???????? ????','????','konu ekle','adicionar assunto','T�rgy hozz�ad�sa','ajouter l\'objet','???????? ???????','Thema hinzuf�gen','aggiungere soggetto','???????????','?????','?????? ????','re addere','menambahkan subjek','?????','??? ??'),
('101','subject_name','subject name','????? ???','nombre del sujeto','??? ???????','Onderwerp naam','??? ????????','????','konu ad?','nome do assunto','t�rgy megnevez�se','nom du sujet','?????????? ?????','Thema Namen','nome del soggetto','??????????','????? ?? ???','???? ?? ???','agitur nomine','nama subjek','???????','?? ??'),
('102','edit_subject','edit subject','???????? ?????','Editar asunto','????? ???????','Onderwerp bewerken','???????? ????','????','d�zenleme konusu','Editar assunto','T�rgy szerkeszt�se','modifier l\'objet','edit ????','Betreff bearbeiten','Modifica oggetto','???????????','????? ??? ????? ????','???? ??????? ????','edit subiecto','mengedit subjek','????','?? ??'),
('103','manage_class','manage class','????? ? ????????','gestionar clase','????? ????','beheren klasse','????????? ?????','???','s?n?f y�netmek','gerenciar classe','kezelni oszt�ly','g�rer classe','?????????? ?????','Klasse verwalten','gestione della classe','??????????????????','???? ?? ??????','???? ?? ???????','genus regendi','mengelola kelas','??????','????? ??'),
...
('105','add_class','add class','?????? ???','agregar la clase','????? ???','voeg klasse','???????? ?????','???','s?n?f eklemek','adicionar classe','hozz� oszt�ly','ajouter la classe','?????????? ????','Klasse hinzuf�gen','aggiungere classe','??????????','???? ???? ????','???? ????','adde genus','menambahkan kelas','??????','???? ??'),
('106','class_name','class name','??????? ???','nombre de la clase','??? ?????','class naam','??? ??????','??','s?n?f ad?','nome da classe','oszt�ly neve','nom de la classe','????? ??? ??????','Klassennamen','nome della classe','????????','???? ???','???? ?? ???','Classis nomine','nama kelas','????','??? ??'),
('107','numeric_name','numeric name','???????? ???','nombre num�rico','??? ?????','numerieke naam','???????? ???','????','Say?sal isim','nome num�rico','numerikus n�v','nom num�rique','?????????? ?????','numerischen Namen','nome numerico','??????????','???? ???','???????? ???','secundum numerum est secundum nomen,','Nama numerik','?????','?? ??'),
('108','name_numeric','name numeric','???????? ??? ???','nombre num�rico','????? ?????','naam numerieke','??????? ????????','????','say?sal isim','nome num�rico','n�v numerikus','nommer num�rique','????? ??????????','nennen numerischen','nome numerico','??????????','???? ???','???????? ?? ???','secundum numerum est secundum nomen,','nama numerik','?????????','?? ???'),
('109','edit_class','edit class','???????? ????','clase de edici�n','?????? ?????','bewerken klasse','??????? ?????','???','s?n?f d�zenle','edi��o classe','szerkeszt�s oszt�ly','modifier la classe','edit ?????????','Klasse bearbeiten','modifica della classe','??????????','????? ????','??????? ????','edit genere','mengedit kelas','?????','?? ???'),
('110','manage_exam','manage exam','??????? ????????','gestionar examen','????? ????????','beheren examen','????????? ???????','????','s?nav? y�netmek','gerenciar exame','kezelni vizsga','g�rer examen','?????????? ?????????','Pr�fung verwalten','gestire esame','????????????','?????? ?? ??????','??????? ?? ???????','curo ipsum','mengelola ujian','?????','?? ??'),
('111','exam_list','exam list','???????? ??????','lista de ex�menes','????? ????????','examen lijst','?????? ???????','????','s?nav listesi','lista de exames','vizsga lista','liste d\'examen','????? ?????????','Pr�fungsliste','elenco esami','?????????','?????? ?????','??????? ????','Lorem ipsum album','daftar ujian','??????','?? ??'),
('112','add_exam','add exam','???????? ???','agregar examen','????? ??????','voeg examen','???????? ???????','????','s?nav eklemek','adicionar exame','hozz� vizsga','ajouter examen','?????????? ?????????','Pr�fung hinzuf�gen','aggiungere esame','???????????','?????? ??? ???? ????','??????? ????','adde ipsum','menambahkan ujian','?????','??? ??'),
('113','exam_name','exam name','???????? ???','nombre del examen','??? ????????','examen naam','???????? ???????','????','s?nav ad?','nome do exame','Vizsga neve','nom de l\'examen','?? ????? ?????????','Pr�fungsnamen','nome dell\'esame','???????','?????? ?? ???','??????? ?? ???','ipsum nomen,','Nama ujian','???','?? ??'),
('114','date','date','?????','fecha','?????','datum','????','??','tarih','data','d�tum','date','??????????','Datum','data','??????','?????','?????','date','tanggal','??','??'),
('115','comment','comment','???????','comentario','?????','commentaar','???????????','??','yorum','coment�rio','megjegyz�s','commentaire','??????','Kommentar','commento','????????','?????','???????','comment','komentar','????','??'),
('116','edit_exam','edit exam','???????? ???????','examen de edici�n','?????? ?????','bewerk examen','??????? ???????','????','edit s?nav?','edi��o do exame','szerkeszt�s vizsga','modifier examen','edit ?????????','edit Pr�fung','modifica esame','???????????','????? ??????','??????? ???????','edit ipsum','mengedit ujian','????','?? ??'),
('117','manage_exam_marks','manage exam marks','??????? ????? ? ????????','gestionar marcas de examen','????? ?????? ????????','beheren examencijfers','????????? ??????????????? ???????','?????','s?nav i?aretleri y�netmek','gerenciar marcas exame','kezelni vizsga jelek','g�rer les marques d\'examen','?????????? ??? ??????? ?????????','Pr�fungsnoten verwalten','gestire i voti degli esami','????????????????????','?????? ?? ?????? ?? ??????','??????? ?? ????? ?? ???????','ipsum curo indicia','mengelola nilai ujian','????????','?? ??? ??'),
('118','manage_marks','manage marks','????? ? ????????','gestionar marcas','????? ??????','beheren merken','????????? ?????','????','i?aretleri y�netmek','gerenciar marcas','kezelni jelek','g�rer les marques','?????????? ??? ???????','Markierungen verwalten','gestire i marchi','?????????????????','?????? ?? ??????','????? ?? ???????','curo indicia','mengelola tanda','??????','??? ??'),
('119','select_exam','select exam','???????? ????????','seleccione examen','??? ????????','selecteer examen','??????? ???????','????','s?nav? se�in','selecionar exame','v�lassza ki a vizsga','s�lectionnez examen','???????? ?????????','Pr�fung w�hlen','seleziona esame','????????','?????? ????? ????','??????? ?? ???','velit ipsum','pilih ujian','?????','??? ??'),
('120','select_class','select class','???? ????????','seleccione clase','??? ???','selecteren klasse','??????? ?????','??????','s?n?f se�in','selecionar classe','v�lassza oszt�ly','s�lectionnez classe','???????? ?????????','Klasse w�hlen','seleziona classe','?????????','???? ????? ????','???? ?? ??? ????','genus eligere,','pilih kelas','??????','???? ??'),
('121','select_subject','select subject','????? ???????? ????','seleccione tema','??? ???????','Selecteer onderwerp','???????? ????','????','konu se�in','selecionar assunto','V�lassza a T�rgy','s�lectionner le sujet','???????? ????','Thema w�hlen','seleziona argomento','???????????','????? ????? ????','???? ?? ???','eligere subditos','pilih subjek','?????','??? ??'),
('122','select_an_exam','select an exam','???? ??????? ????????','seleccione un examen','??? ????????','selecteer een examen','??????? ???????','????','Bir s?nav se�in','selecionar um exame','v�lasszon ki egy vizsga','s�lectionner un examen','???????? ??? ???????','W�hlen Sie eine Pr�fung','selezionare un esame','????????','?????? ????? ????','?? ??????? ?? ???','Eligebatur autem ipsum','pilih ujian','?????','??? ??'),
('123','mark_obtained','mark obtained','??????? ???????','calificaci�n obtenida','??????? ?????? ???','markeren verkregen','???????? ????????','???','i?aretlemek elde','marca obtida','jel�lje kapott','marquer obtenu','???? ??? ??????????','Markieren Sie erhalten','contrassegnare ottenuto','??????????????????????','???? ?? ????','??? ???????','attende obtinuit','menandai diperoleh','?????','?? ??'),
('124','attendance','attendance','????????','asistencia','??????','opkomst','????????????','??','kat?l?m','comparecimento','r�szv�tel','pr�sence','????????','Teilnahme','partecipazione','????????????','?????','????????','auscultant','kehadiran','??','??'),
('125','manage_grade','manage grade','????? ????????','gesti�n de calidad','????? ????','beheren leerjaar','????????? ?????','???','notu y�netmek','gerenciar grau','kezelni fokozat','g�rer de qualit�','?????????? ?????????','Klasse verwalten','gestione grade','??????????','???? ?? ??????','????? ?? ???????','moderari gradu','mengelola kelas','???????','?? ??'),
('126','grade_list','grade list','????? ??????','Lista de grado','????? ????','cijferlijst','?????? ??????','????','s?n?f listesi','lista grau','fokozat lista','liste de qualit�','????? ??????','Notenliste','elenco grade','??????????','???? ?????','????? ?? ????','gradus album','daftar kelas','??????','?? ??'),
('127','add_grade','add grade','????? ??? ????','a�adir grado','????? ????','voeg leerjaar','???????? ?????','???','not eklemek','adicionar grau','hozz� fokozat','ajouter note','???????? ??????','Klasse hinzuf�gen','aggiungere grade','?????????','???? ??? ???? ????','????? ????','adde gradum,','menambahkan kelas','???????','??? ??'),
('128','grade_name','grade name','????? ???','Nombre de grado','??? ????','rangnaam','???????? ?????','????','s?n?f ad?','nome da classe','fokozat n�v','nom de la cat�gorie','????? ??????','Klasse Name','nome del grado','????????','???? ???','????? ?? ???','nomen, gradus,','nama kelas','?????','?? ??'),
...
('130','mark_from','mark from','????? ????','marca de','????? ??','mark uit','???? ??','???','mark dan','marca de','jel�l�st','marque de','???? ???','Marke aus','segno da','??????????????','???? ??','????? ??','marcam','mark dari','?????','???'),
('131','mark_upto','mark upto','??????? ???????','marcar hasta','??????? ???','mark tot','???????? ??','????','kadar i?aretlemek','marcar at�','jel�lje upto','marquer jusqu\'�','???? ?????','Markieren Sie bis zu','contrassegnare fino a','?????????????????','?? ?? ????','?? ???????','Genitus est notare','menandai upto','???????','???'),
('132','edit_grade','edit grade','???????? ?????','edit grado','????? ????','Cijfer bewerken','??????? ??????','????','edit notu','edi��o grau','szerkeszt�s fokozat','edit qualit�','edit ??????','edit Grad','modifica grade','?????????','????? ????','??????? ?????','edit gradu','mengedit kelas','??????','?? ??'),
('133','manage_class_routine','manage class routine','??????? ????? ????????','gestionar rutina de la clase','????? ?????? ?????????','beheren klasroutine','????????? ?????? ??????','?????','s?n?f rutin y�netmek','gerenciar rotina classe','kezelni class rutin','g�rer la routine de classe','?????????????? ???? ???????','verwalten Klasse Routine','gestione classe di routine','?????????????????????????','???? ????? ?? ??????','???? ???????? ?? ???????','uno in genere tractare','mengelola rutinitas kelas','??????????','??? ???? ??'),
('134','class_routine_list','class routine list','??????? ????? ??????','clase de lista de rutina','????? ????????? ??????','klasroutine lijst','????? ?????? ??????','??????','s?n?f rutin listesi','classe de lista de rotina','oszt�ly rutin lista','classe liste routine','????? list ????????','Klasse Routine Liste','classe lista di routine','???????????????','???? ????? ?? ????? ?????','???? ???????? ????','uno genere album','Daftar rutin kelas','?????????','??? ?? ??'),
('135','add_class_routine','add class routine','??????? ????? ?????','a�adir rutina de la clase','????? ??? ?????????','voeg klasroutine','???????? ???????????? ??????','?????','s?n?f rutin eklemek','adicionar rotina classe','hozz� class rutin','ajouter routine de classe','?????????? ???? ???????','Klasse hinzuf�gen Routine','aggiungere classe di routine','?????????????????','???? ????? ??? ???? ????','???? ???????? ????','adde genus moris','menambahkan rutin kelas','???�???????','??? ??? ??'),
('136','day','day','???','d�a','???','dag','????','?','g�n','dia','nap','jour','?????','Tag','giorno','???','??','???','die,','hari','?','?'),
('137','starting_time','starting time','?????? ????','tiempo de inicio','???? ?????','starttijd','????? ??????','????','ba?lang?� ??zaman?','tempo come�ando','ind�t�si id?','temps de d�marrage','??? ???????','Startzeit','tempo di avviamento','????????????','??? ???? ????','??? ?? ?????? ??','tum satus','waktu mulai','????','?? ??'),
('138','ending_time','ending time','???? ???','hora de finalizaci�n','????? ??????','eindtijd','????? ?????????','????','biti? zaman?n?','tempo final','befejez�si id?pont','heure de fin','??? ?????','Endzeit','ora finale','???????????','??? ???','??? ?????? ???? ??','et finis temporis,','akhir waktu','????','?? ??'),
('139','edit_class_routine','edit class routine','???????? ????? ?????','rutina de la clase de edici�n','?????? ????? ?????????','bewerk klasroutine','????????? ?????????????? ?????','?????','s?n?f d�zenle rutin','rotina de edi��o de classe','szerkeszt�s oszt�ly rutin','routine modifier de classe','edit ???? ???????','edit Klasse Routine','modifica della classe di routine','?????????????????????','????? ???? ?????','??????? ???? ????????','edit uno genere','rutin mengedit kelas','??????????','?? ??? ??'),
('140','manage_invoice/payment','manage invoice/payment','????? / ??????? ????????','gestionar factura / pago','????? ?????? / ???','beheren factuur / betaling','????????? ????? / ??????','????/??','fatura / �deme y�netmek','gerenciar fatura / pagamento','kezelni sz�mla / fizet�si','g�rer facture / paiement','?????????? ?????????? / ????????','Verwaltung Rechnung / Zahlung','gestione fattura / pagamento','???????????????? / ???????????','?????? / ??????? ?? ??????','????? / ?????? ?? ???????','curo cautionem / solutionem','mengelola tagihan / pembayaran','???/????','???? / ?? ??'),
('141','invoice/payment_list','invoice/payment list','????? / ??????? ??????','lista de facturas / pagos','????? ?????? / ???','factuur / betaling lijst','?????? ????? / ??????','??/????','fatura / �deme listesi','lista de fatura / pagamento','sz�mla / fizet�si lista','liste facture / paiement','????? ?????????? / ????????','Rechnung / Zahlungsliste','elenco fattura / pagamento','???????????????? / ???????????','?????? / ??????? ?? ?????','????? / ?????? ????','cautionem / list pretium','daftar tagihan / pembayaran','???/????','???? / ?????'),
('142','add_invoice/payment','add invoice/payment','????? / ??????? ???','a�adir factura / pago','????? ?????? / ???','voeg factuur / betaling','???????? ????? / ??????','????/??','fatura / �deme eklemek','adicionar factura / pagamento','hozz� sz�mla / fizet�si','ajouter facture / paiement','???????? ?????????? / ????????','hinzuf�gen Rechnung / Zahlung','aggiungere fatturazione / pagamento','??????????????? / ???????????','?????? / ??????? ????','????? / ?????? ??????','add cautionem / solutionem','menambahkan tagihan / pembayaran','???/?????','?? / ??? ??'),
('143','title','title','?????','t�tulo','???','titel','????????','??','ba?l?k','t�tulo','c�m','titre','??????','Titel','titolo','??????????','?????','??????','title','judul','????','??'),
('144','description','description','?????','descripci�n','???','beschrijving','????????','??','tan?m','descri��o','le�r�s','description','?????????','Beschreibung','descrizione','??????','?????','?????','description','deskripsi','??','??'),
('145','amount','amount','??????','cantidad','????','bedrag','??????????','?','miktar','quantidade','mennyis�g','montant','????','Menge','importo','?????','???','????','tantum','jumlah','?','?'),
('146','status','status','??????','estado','????','toestand','??????','??','durum','estado','�llapot','statut','?????????','Status','stato','?????','????','??????','status','status','?????','??'),
('147','view_invoice','view invoice','????? ?????','vista de la factura','??? ????????','view factuur','??? ?????-???????','????','view fatura','vista da fatura','view sz�mla','vue facture','??????? ?????????','Ansicht Rechnung','vista fattura','????????????','?????? ??????','????? ?????','propter cautionem','lihat faktur','??????','?? ??'),
('148','paid','paid','??????','pagado','?????','betaald','??????????','??','�cretli','pago','fizetett','pay�','??????????','bezahlt','pagato','????????','??? ???','???????','solutis','dibayar','?????','??'),
('149','unpaid','unpaid','???????','no pagado','??? ?????','onbetaald','????????????','??','�denmemi?','n�o remunerado','kifizetetlen','non r�mun�r�','????????','unbezahlt','non pagato','?????????????','??? ??????','???????','non est constitutus,','dibayar','???','???? ??'),
('150','add_invoice','add invoice','????? ???','a�adir factura','????? ????????','voeg factuur','???????? ????','????','faturay? eklemek','adicionar fatura','hozz� sz�mla','ajouter facture','????????? ?????????','Rechnung hinzuf�gen','aggiungere fattura','???????????????','?????? ??? ????','????? ????','add cautionem','menambahkan faktur','??????','??? ??'),
('151','payment_to','payment to','???????','pago a','??? ?','betaling aan','??????','??','i�in �deme','pagamento','fizet�s','paiement','???????','Zahlung an','pagamento','??????????????','???????','?? ??????','pecunia','pembayaran kepada','?????','? ??'),
('152','bill_to','bill to','???','proyecto de ley para','????? ????? ?','wetsvoorstel om','???????????? ?','??','bill','projeto de lei para','t�rv�nyjavaslat','projet de loi','?????????? ??? ???','Gesetzentwurf zur','disegno di legge per','???','??','??? ?? ???','latumque','RUU untuk','????','??'),
('153','invoice_title','invoice title','????? ???????','T�tulo de la factura','????? ????????','factuur titel','???????? ?????','????','fatura ba?l?k','t�tulo fatura','sz�mla c�m','titre de la facture','?????? ?????????','Rechnungs Titel','title fattura','??????????????','?????? ?????','????? ??????','title cautionem','judul faktur','????????','?? ??'),
('154','invoice_id','invoice id','????? ????','Identificaci�n de la factura','?????? ????','factuur id','????-??????? ID','????','fatura id','id fatura','sz�mla id','Identifiant facture','id ?????????','Rechnung-ID','fattura id','?????????????????','?????? ID','????? ????','id cautionem','faktur id','???ID','?? ID'),
('155','edit_invoice','edit invoice','???????? ?????','edit factura','????? ????????','bewerk factuur','?????????????? ?????-???????','????','edit fatura','edi��o fatura','szerkeszt�s sz�mla','modifier la facture','edit ?????????','edit Rechnung','modifica fattura','???????????????','????? ??????','??????? ?????','edit cautionem','mengedit faktur','?????','?? ??'),
('156','manage_library_books','manage library books','?????????? ?? ? ????????','gestionar libros de la biblioteca','????? ????? ?????','beheren bibliotheekboeken','????????? ???????????? ?????','????','kitaplar? k�t�phane y�netmek','gerenciar os livros da biblioteca','kezelni k�nyvt�ri k�nyvek','g�rer des livres de biblioth�que','?????????????? ?? ?????? ??? ???????????','B�cher aus der Bibliothek verwalten','gestire i libri della biblioteca','???????????????????????','??? ???? ?? ?????? ????','????????? ?? ???????? ?? ???????','curo bibliotheca librorum,','mengelola buku perpustakaan','????????','??? ? ??'),
...
('158','add_book','add book','?? ???','A�adir libro','????? ????','boek toevoegen','???????? ?????','???','kitap eklemek','adicionar livro','K�nyv hozz�ad�sa','ajouter livre','????????? ?? ??????','Buch hinzuf�gen','aggiungere il libro','????????????','???? ????','?????? ????','adde libri','menambahkan buku','????','?? ??'),
('159','book_name','book name','?????? ???','Nombre del libro','??? ??????','boeknaam','???????? ?????','??','kitap ad?','nome livro','book n�v','nom de livre','?? ????? ??? ???????','Buchnamen','nome del libro','???????????','???? ?? ???','????? ?? ???','librum nomine','nama buku','????','? ??'),
('160','author','author','????','autor','??????','auteur','?????','??','yazar','autor','szerz?','auteur','??????????','Autor','autore','????????','????','????','auctor','penulis','??','??'),
('161','price','price','???','precio','?????','prijs','????','??','fiyat','pre�o','�r','prix','????','Preis','prezzo','????','????','????','price','harga','??','??'),
('162','available','available','??????','disponible','????','beschikbaar','?????????','???','mevcut','dispon�vel','rendelkez�sre �ll�','disponible','??????????','verf�gbar','disponibile','????????????','??????','??????','available','tersedia','?????','???'),
('163','unavailable','unavailable','????????','indisponible','??? ????','niet beschikbaar','??????????','???','yok','indispon�vel','�rhet? el','indisponible','?????????','nicht verf�gbar','non disponibile','?????','?????? ????','????????','unavailable','tidak tersedia','??????','??'),
('164','edit_book','edit book','???????? ??','libro de edici�n','???? ?????','bewerk boek','??????? ?????','????','edit kitap','edi��o do livro','edit k�nyv','edit livre','?????????????? ?? ??????','edit Buch','modifica book','????????????','????? ????','??????? ??????','edit Liber','mengedit buku','????','?? ?'),
('165','manage_transport','manage transport','?????? ? ????????','gestionar el transporte','????? ?????','beheren van vervoerssystemen','????????? ???????????','????','ula??m y�netmek','gerenciar o transporte','kezelni a k�zleked�s','la gestion du transport','?????????? ??? ?????????','Transport verwalten','gestire i trasporti','?????????????????','??? ? ??? ?? ??????','?????? ?? ???????','curo onerariis','mengelola transportasi','?????','?? ??'),
('166','transport_list','transport list','?????? ??????','Lista de transportes','????? ?????','lijst vervoer','???? ?????????','????','ta??ma listesi','Lista de transportes','sz�ll�t�s lista','liste de transport','????? ??? ?????????','Transportliste','elenco trasporti','??????????????','??? ? ??? ?? ?????','?????? ????','turpis album','daftar transport','????','?? ??'),
('167','add_transport','add transport','?????? ??? ????','a�adir el transporte','????? ?????','voeg vervoer','???????? ?????????','????','ta??ma ekle','adicionar transporte','hozz� a k�zleked�s','ajouter transports','????????? ?????????','add-Transport','aggiungere il trasporto','?????????????','??? ? ??? ????','?????? ????','adde onerariis','tambahkan transportasi','??????????','??? ??'),
('168','route_name','route name','??? ???','nombre de la ruta','??? ?????','naam van de route','??? ???????','????','rota ismi','nome da rota','�tvonal nev�t','nom de la route','????? ?????????','Routennamen','nome del percorso','???????????','????? ???','????? ?? ???','iter nomine','Nama rute','??????','?? ??'),
('169','number_of_vehicle','number of vehicle','?????? ??????','n�mero de veh�culo','??? ?? ????????','aantal voertuigkilometers','?????????? ??????????','?????','Arac?n say?s?','n�mero de ve�culo','sz�m� g�pj�rm?','nombre de v�hicules','??????? ??? ????????','Anzahl der Fahrzeug','numero di veicolo','????????????????','???? ?? ?????','???? ?? ??????','de numero scilicet vehiculum','jumlah kendaraan','????','??? ?'),
('170','route_fare','route fare','??? ?????','ruta hacer','?????? ????','route doen','??????? ??????','???','yol yapmak','rota fazer','�tvonal do','itin�raire faire','???????? ?????','Route zu tun','r','?????????','????? ????','????? ????','iter faciunt,','rute lakukan','????','??? ?'),
('171','edit_transport','edit transport','???????? ??????','transporte de edici�n','????? ?????','vervoer bewerken','??????? ?????????','????','edit ula??m','edi��o transporte','szerkeszt�s sz�ll�t�s','transport modifier','edit ?????????','edit Transport','modifica dei trasporti','?????????????','????? ??? ? ???','??????? ??????','edit onerariis','mengedit transportasi','????','?? ??'),
('172','manage_dormitory','manage dormitory','??????? ? ????????','gestionar dormitorio','????? ????','beheren slaapzaal','????????? ?????????','????','yurt y�netmek','gerenciar dormit�rio','kezelni koll�giumi','g�rer dortoir','?????????? ???????','Schlafsaal verwalten','gestione dormitorio','???????????','??????? ?? ??????','????????? ?? ???????','curo dormitorio','mengelola asrama','????','???? ??'),
('173','dormitory_list','dormitory list','??????? ??????','lista dormitorio','????? ????','slaapzaal lijst','?????? ?????????','????','yurt listesi','lista dormit�rio','koll�giumi lista','liste de dortoir','????? ???????','Schlafsaal Liste','elenco dormitorio','????????????','??????? ?????','????????? ????','dormitorium album','daftar asrama','?????','??? ??'),
('174','add_dormitory','add dormitory','??????? ???','a�adir dormitorio','????? ????','voeg slaapzaal','???????? ?????????','????','yurt ekle','adicionar dormit�rio','hozz� koll�giumi','ajouter dortoir','???????? ???????','Schlaf hinzuf�gen','aggiungere dormitorio','??????????','??????? ????','????????? ????','adde dormitorio','menambahkan asrama','????','???? ??'),
('175','dormitory_name','dormitory name','??????? ???','Nombre del dormitorio','??? ??????','slaapzaal naam','??? ?????????','???','yurt ad?','nome dormit�rio','koll�giumi n�v','nom de dortoir','????? ???????','Schlaf Namen','Nome dormitorio','?????????','??????? ???','????????? ???','dormitorium nomine','Nama asrama','??','??? ??'),
('176','number_of_room','number of room','???? ??????','n�mero de habitaci�n','??? ?????','aantal kamer','????? ???????','????','oda say?s?','n�mero de quarto','sz�ma szob�ban','nombre de salle','??? ?????? ??? ????????','Anzahl der Zimmer','numero delle camera','????????????','???? ?? ?????','???? ?? ??????','numerus locus','Jumlah kamar','????','?? ?'),
('177','manage_noticeboard','manage noticeboard','?????????? ????????','gestionar tabl�n de anuncios','????? ???????','beheren prikbord','????????? ????? ??????????','????','Noticeboard y�netmek','gerenciar avisos','kezelni �zen?fal�n','g�rer panneau d\'affichage','?????????? ????????????','Brett verwalten','gestione bacheca','????????????????','noticeboard ?? ??????','Noticeboard ?? ???????','curo noticeboard','mengelola pengumuman','??????','? noticeboard ??'),
('178','noticeboard_list','noticeboard list','?????????? ??????','tabl�n de anuncios de la lista','????? ???????','prikbord lijst','?????? ????? ??? ??????????','????','noticeboard listesi','lista de avisos','�zen?fal�n lista','liste de panneau d\'affichage','????? ????????????','Brett-Liste','elenco bacheca','????????????????','noticeboard ?????','Noticeboard ????','noticeboard album','daftar pengumuman','?????','? noticeboard ??'),
('179','add_noticeboard','add noticeboard','?????????? ???','a�adir tabl�n de anuncios','????? ???????','voeg prikbord','???????? ????? ??????????','????','Noticeboard ekle','adicionar avisos','hozz� �zen?fal�n','ajouter panneau d\'affichage','???????? ????????????','Brett hinzuf�gen','aggiungere bacheca','???????????????','noticeboard ????','Noticeboard ????','adde noticeboard','menambahkan pengumuman','??????','? noticeboard ??'),
('180','notice','notice','?????????','aviso','?????','kennisgeving','???????????','??','uyar?','aviso','�rtes�t�s','d�lai','??????????','Bekanntmachung','avviso','???????????','????','?????','Observa','pemberitahuan','??','??'),
('181','add_notice','add notice','????? ??? ????','a�adir aviso','????? ?????','voeg bericht','???????? ???????????','????','haber ekle','adicionar aviso','hozz� �rtes�t�s','ajouter un avis','????????? ??????????','Hinweis hinzuf�gen','aggiungere preavviso','????????????????????????','???? ?? ????? ????','????? ????','addunt et titulum','tambahkan pemberitahuan','?????','??? ??'),
('182','edit_noticeboard','edit noticeboard','???????? ??????????','edit tabl�n de anuncios','????? ???????','bewerk prikbord','??????? ????? ??? ??????????','????','edit noticeboard','edi��o de avisos','szerkeszt�s �zen?fal�n','modifier panneau d\'affichage','edit ????????????','Brett bearbeiten','modifica bacheca','???????????????','??? ????? ???? noticeboard','??????? Noticeboard','edit noticeboard','mengedit pengumuman','?????','??? noticeboard'),
('183','system_name','system name','????????? ???','Nombre del sistema','??? ??????','Name System','??? ???????','????','sistemi ad?','nome do sistema','rendszer neve','nom du syst�me','????? ??? ??????????','Systemnamen','nome del sistema','????????','???? ?? ???','?????? ???','ratio nominis','Nama sistem','?????','??? ??'),
('184','save','save','?????','guardar','???','besparen','?????????','??','kurtarmak','salvar','kiv�ve','sauver','?????','sparen','salvare','???????','?? ????? ??','?????','salvum','menyimpan','??','??'),
('185','system_title','system title','??????? ???????','T�tulo de sistema','????? ??????','systeem titel','???????? ???????','????','Sistem ba?l?k','t�tulo sistema','rendszer c�m','titre du syst�me','?????? ??? ??????????','System-Titel','titolo di sistema','????????','???? ?????','?????? ??????','ratio title','title sistem','?????????','??? ??'),
...
('187','currency','currency','??????','moneda','????','valuta','??????','??','para','moeda','valuta','monnaie','???????','W�hrung','valuta','???????','?????','??????','currency','mata uang','??','??'),
('188','phrase_list','phrase list','????? ??????','lista de frases','????? ????','zinnenlijst','?????? ?????','????','ifade listesi','lista de frases','kifejez�s lista','liste de phrase','????? ?????','Phrasenliste','elenco frasi','?????????','???? ?????','???????? ????','dicitur album','Daftar frase','???????','?? ??'),
('189','add_phrase','add phrase','????????? ?????','a�adir la frase','????? ?????','voeg zin','???????? ?????','????','ifade eklemek','adicionar frase','adjunk kifejez�st','ajouter la phrase','????????? ?????','Begriff hinzuf�gen','aggiungere la frase','????????','???? ????','???????? ??????','addere phrase','menambahkan frase','???????','??? ??'),
('190','add_language','add language','???? ?????','a�adir idioma','????? ???','add taal','???????? ????','????','dil ekle','adicionar l�ngua','nyelv hozz�ad�sa','ajouter la langue','????????? ??????','Sprache hinzuf�gen','aggiungere la lingua','?????????','???? ?? ????','???? ??????','addere verbis','menambahkan bahasa','?????','??? ??'),
('191','phrase','phrase','?????','frase','???????','frase','?????','??','ifade','frase','kifejez�s','phrase','?????','Ausdruck','frase','???','????','????????','phrase','frasa','????','?'),
('192','manage_backup_restore','manage backup restore','??????? ?????????? ? ????????','gestionar copias de seguridad a restaurar','????? ??????? ????? ?????????','beheer van back-up herstellen','????????? ???????????? ?????????? ???????????','??????','yedekleme geri y�netmek','gerenciar o backup de restaura��o','kezelni a biztons�gi ment�s vissza�ll�t�sa','g�rer de restauration de sauvegarde','?????????? ?????????? ?????????? ?????????','verwalten Backup wiederherstellen','gestire il ripristino di backup','????????????????????????????','??? ?? ???? ??????','????? ???? ?? ???????','curo tergum restituunt','mengelola backup restore','??????????????','?? ?? ??'),
...
('196','invoice','invoice','?????','factura','??????','factuur','????-???????','??','fatura','fatura','sz�mla','facture','?????????','Rechnung','fattura','?????????????','??????','????','cautionem','faktur','?????','??'),
('197','book','book','??','libro','????','boek','?????','?','kitap','livro','k�nyv','livre','??????','Buch','libro','???????','????','?????','Liber','buku','?','?'),
('198','all','all','??','todo','??','alle','???','??','t�m','tudo','minden','tout','???','alle','tutto','???????','????','??','omnes','semua','???','??'),
('199','upload_&_restore_from_backup','upload & restore from backup','????? &amp; ??????? ???? ??????????','cargar y restaurar copia de seguridad','????? ???????? ?? ?????? ??????????','uploaden en terugzetten van een backup','????????? ? ???????????? ?? ????????? ?????','?????????','y�kleyebilir ve yedekten geri y�kleme','fazer upload e restaura��o de backup','felt�lteni �s vissza�ll�tani backup','t�l�charger et restauration de la sauvegarde','????????? ??? ????????? ??? backup','Upload &amp; Wiederherstellung von Backups','caricare e ripristinare dal backup','???????????????????????????????????','?? ??? ???? ??? ??? ?? ?? ????','????? ?? ????? ?? ????','restituo ex tergum upload,','meng-upload &amp; restore dari backup','?????????????????','??? ? ???? ??'),
('200','manage_profile','manage profile','????????? ????????','gestionar el perfil','????? ????? ??????','te beheren!','????????? ????????','??????','profilini y�netmek','gerenciar o perfil','Profil kezel�se','g�rer le profil','?????????????? ?? ??????','Profil verwalten','gestire il profilo','????????????????','??????? ?? ??? ????','???????? ?? ???????','curo profile','mengelola profil','???????????????','??? (? ??) ??'),
('201','update_profile','update profile','???????? ?????','actualizar el perfil','????? ????? ??????','Profiel bijwerken','???????? ???????','??????','profilinizi g�ncelleyin','atualizar o perfil','friss�teni profil','mettre � jour le profil','??????????? ?? ??????','Profil aktualisieren','aggiornare il profilo','?????????????','??????? ?? ?? ???','????????? ?????','magna eget ipsum','memperbarui profil','?????????','???? ????'),
('202','new_password','new password','???? ??????????','nueva contrase�a','???? ???? ?????','nieuw wachtwoord','????? ??????','???','Yeni ?ifre','nova senha','�j jelsz�','nouveau mot de passe','??? ??????','Neues Passwort','nuova password','????????????','??? ??? ???','??? ???????','novum password','kata sandi baru','????????','? ??'),
('203','confirm_new_password','confirm new password','???? ?????????? ??????? ????','confirmar nueva contrase�a','????? ???? ?????? ???????','Bevestig nieuw wachtwoord','??????????? ????? ??????','?????','yeni parolay? onaylay?n','confirmar nova senha','er?s�tse meg az �j jelsz�t','confirmer le nouveau mot de passe','????????????? ?? ??? ??????','Best�tigen eines neuen Kennwortes','conferma la nuova password','??????????????????','??? ??? ??? ?? ?????','?? ??????? ?? ??????','confirma novum password','konfirmasi password baru','???????????','? ??? ?????'),
('204','update_password','update password','?????????? ?????','actualizar la contrase�a','????? ???? ????','updaten wachtwoord','???????? ??????','????','Parolan?z? g�ncellemek','atualizar senha','friss�ti jelsz�','mettre � jour le mot de passe','??????????? ??? ?????? ?????????','Kennwort aktualisieren','aggiornare la password','????????????????','??? ?? ???','??????? ??????','scelerisque eget','memperbarui sandi','????????','??? ????'),
('205','teacher_dashboard','teacher dashboard','?????? ??????????','tablero maestro','???? ????? ?????? ??????','leraar dashboard','??????? ????????? ??????','?????','�?retmen pano','dashboard professor','tan�r m?szerfal','enseignant tableau de bord','?????? ??? ?????????????','Lehrer-Dashboard','dashboard insegnante','?????????','????? ??? ????','?????? ????????','magister Dashboard','dashboard guru','??????????','?? ?? ??'),
('206','backup_restore_help','backup restore help','??????? ?????????? ???????','copia de seguridad restaurar ayuda','??????? ????? ????????? ????????','backup helpen herstellen','???????????? ????????? ????? ??????','???????','yedekleme yard?m geri','de backup restaurar ajuda','Backup Restore seg�ts�g�vel','restauration de sauvegarde de l\'aide','?????????? ?????????? ????????? ???????','Backup wiederherstellen Hilfe','Backup Restore aiuto','???????????????????????????????????','??? ?? ?? ??? ????','????? ??? ????','auxilium tergum restituunt','backup restore bantuan','????????????','?? ??? ??'),
('207','student_dashboard','student dashboard','????? ??????????','salpicadero estudiante','???? ??????? ????????','student dashboard','??????? ????????? ??????','??????','�?renci paneli','dashboard estudante','tanul� m?szerfal','tableau de bord de l\'�l�ve','?????? ??? ????????','Sch�ler Armaturenbrett','studente dashboard','?????????????????','???? ??? ?? ??? ????','????? ????????','Discipulus Dashboard','dashboard mahasiswa','??????????','?? ?? ??'),
('208','parent_dashboard','parent dashboard','??????? ??????????','salpicadero padres','???? ????? ?????? ????','ouder dashboard','???????? ????????? ??????','?????','ebeveyn kontrol paneli','dashboard pai','sz�l? m?szerfal','parent tableau de bord','??????? ??????','Mutter Armaturenbrett','dashboard genitore','?????????????????????','?????? ?? ??? ????','???? - ???? ????????','Dashboard parent','orangtua dashboard','?????','?? ?? ??'),
('209','view_marks','view marks','????? ?????','Vista marcas','?????? ???','view merken','??? ?????','????','g�r�n�m� i?aretleri','vista marcas','view jelek','Vue marques','?????? ?????','Ansicht Marken','Vista marchi','?????????????????','?????? ??????','????? ?? ?????','propter signa','lihat tanda','??????','?? ??'),
('210','delete_language','delete language','???? ?????','eliminar el lenguaje','??? ?????','verwijderen taal','??????? ????','????','dili silme','excluir l�ngua','t�rl�se nyelv','supprimer la langue','???????? ??????','Sprache l�schen','eliminare lingua','??????','???? ?? ???? ?? ???','???? ?? ?????','linguam turpis','menghapus bahasa','???????','??? ??'),
('211','settings_updated','settings updated','?????? ?????','configuraci�n actualizado','????????? ???????','instellingen bijgewerkt','????????? ?????????','????','ayarlar? g�ncellendi','defini��es atualizadas','be�ll�t�sok friss�tve','param�tres mis � jour','????????? ?????????','Einstellungen aktualisiert','impostazioni aggiornate','?????????????????????','??????? ?? ???? ????','???????? ??????','venenatis eu','pengaturan diperbarui','?????','??? ????'),
('212','update_phrase','update phrase','????? ?????','actualizaci�n de la frase','????? ???????','Update zin','?????????? ?????','????','g�ncelleme ifade','atualiza��o frase','friss�t�st kifejez�s','mise � jour phrase','????????? ?????','Update Begriff','aggiornamento frase','???????????','?? ??? ????','?????? ????????','eget dictum','frase pembaruan','??????','???? ??'),
('213','login_failed','login failed','???? ?????? ??????','Error de acceso','??? ????? ??????','inloggen is mislukt','?????? ?????','????','giri? ba?ar?s?z oldu','Falha no login','bejelentkez�s sikertelen','�chec de la connexion','??????? ???????','Fehler bei der Anmeldung','Accesso non riuscito','??????????????????','??? ?? ?????','????? ????','tincidunt defecit','Login gagal','???????????','??? ??'),
...
('215','client 1','client 1','???????????? 1','cliente 1','?????? 1','client 1','?????? 1','???1','istemcisi 1','cliente 1','�gyf�l 1','client 1','?????? 1','Client 1','client 1','?????? 1','?????? 1','?????? 1','I huius','client 1','??????1','????? 1'),
('216','buyer','buyer','??????','comprador','????','koper','??????????','??','al?c?','comprador','vev?','acheteur','?????????','K�ufer','compratore','???????','??????','???????','qui emit,','pembeli','????','???'),
('217','purchase_code','purchase code','????? ???','c�digo de compra','??? ??????','aankoop code','??????? ???','????','sat?n alma kodu','c�digo de compra','v�s�rl�si k�dot','code d\'achat','??????? ?????','Kauf-Code','codice di acquisto','???????????????','??????? ?? ???','???? ???','Mauris euismod','kode pembelian','?????','?? ??'),
('218','system_email','system email','??????? ?????','correo electr�nico del sistema','???? ?????? ??????????','systeem e-mail','??????? ??????????? ?????','????','sistem e-posta','e-mail do sistema','a rendszer az e-mail','email de syst�me','e-mail ??????????','E-Mail-System','email sistema','??????????','???? ?? ?? ???','??????? ????','Praesent sit amet','email sistem','??????????','??? ?? ??'),
('219','option','option','??????','opci�n','????','optie','???????','??','se�enek','op��o','opci�','option','???????','Option','opzione','???????????','????','??????','optio','pilihan','?????','???'),
('220','edit_phrase','edit phrase','???????? ?????','edit frase','????? ???????','bewerk zin','??????? ?????','???','edit ifade','edi��o frase','szerkeszt�s kifejez�s','modifier phrase','edit ?????','edit Begriff','modifica frase','????????','????? ?? ????','??????? ????????','edit phrase','mengedit frase','??????','?? ?'),
...
('42','66729','2018-09-07','Dawn Potter','45','Completed'),
...
INSERT INTO `users` VALUES ('26','Jon ','Snow','jon','jonathaon','jon@gmail.com','99009900','0','2016-11-11','Footbal, volleyball, dddd','BE','DDT','USA','newyork','0','3','452005','about desc.'),
('30','yemqHDGbASghVu','hcWntOcErdNAcklhyj','QIuDjsqpMkLGUDESEm','','','jgDUxaeJiZCkuaoVh','fVZnYMKEtIa','0000-00-00','cheap viagra','spdNvoiqwOxc','YuvNreRnGhEvaa',' <a href=\"http://www.discountsildenafilonline.com/\">generic viagra online pharmacy</a> <a href=\"http://www.wwwgenericsildenafilonlineusa.com/\">cheap generic viagra</a> ','xcREtODtJe','ibFsTlIsQfaTwBh','ATptExgQvFaVt','mZozqIJVFug',' <a href=\"http://www.discountsildenafilonline.com/\">generic viagra online pharmacy</a> <a href=\"http://www.wwwgenericsildenafilonlineusa.com/\">cheap generic viagra</a> '); 
...
-- 
--Indexes for table `booking_status_master` 
-- 
ALTER TABLE `booking_status_master`
...
-- 
--Indexes for table `cruises_booking` 
-- 
ALTER TABLE `cruises_booking`
...
-- 
--Indexes for table `library_membership` 
-- 
...
-- 
--Indexes for table `multilang` 
-- 
ALTER TABLE `multilang`
 ADD PRIMARY KEY (`id`);


-- 
--Indexes for table `multilang_myisam` 
-- 
ALTER TABLE `multilang_myisam`
 ADD PRIMARY KEY (`id`);
...
ALTER TABLE `products`
 ...
 ADD KEY `productLine` (`product_line`);
...
-- 
--Indexes for table `website_design_request` 
-- 
ALTER TABLE `website_design_request`
 ADD PRIMARY KEY (`request_id`);
...
-- 
--Indexes for table `x0t2u_users` 
-- 
ALTER TABLE `x0t2u_users`
 ADD PRIMARY KEY (`id`),
 ADD KEY `idx_name` (`name`(100)),
 ADD KEY `idx_block` (`block`),
 ADD KEY `username` (`username`),
