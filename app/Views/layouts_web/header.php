...
<head>
    ...
    <link rel="stylesheet" href='{{ $_ENV["BASE_URL"] }}css/icon-picker.css'>
    <link rel="stylesheet" href='{{ $_ENV["BASE_URL"] }}css/glyphicon.css'>
    <link rel="stylesheet" href='{{ $_ENV["BASE_URL"] }}css/dashicons.css'>
    <link rel="stylesheet" href='{{ $_ENV["BASE_URL"] }}css/jquery.mCustomScrollbar.css'>
